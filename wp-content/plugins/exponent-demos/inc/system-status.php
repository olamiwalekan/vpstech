...
if( !function_exists( 'BS_get_set_button' ) ) {
 ...
 * @return string
 */
if( !function_exists( 'be_stat_green_or_red' ) ) {
...
if( !function_exists( 'sss_get_host' ) ) {
...
if( !function_exists( 'exp_demos_system_status_tpl' ) ) {
	function exp_demos_system_status_tpl() {
		global $wpdb;
	?>
