...
<div class="container text-center maintenance-wrap">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<h1 class="maintenance-title"><?php esc_html_e( 'Coming Soon', 'pixzlo' ); ?></h1>
	...
	<div class="row">
		...
		<div class="col-md-12 maintenance-footer">
			...
			<p><?php esc_html_e( 'We are currently working on an awesome new site, which will be ready soon. Stay Tuned!', 'pixzlo' ); ?></p>
