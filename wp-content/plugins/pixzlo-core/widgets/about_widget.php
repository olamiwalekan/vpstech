...
add_action( 'widgets_init', 'pixzlo_zozo_about_load_widget' );

function pixzlo_zozo_about_load_widget() {

	register_widget( 'pixzlo_zozo_about_widget' );

}

class pixzlo_zozo_about_widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array( 'classname' => 'zozo_about_widget', 'description' => esc_html__('A widget that displays an About widget', 'pixzlo-core') );

		$control_ops = array('id_base' => 'zozo_about_widget' );

		parent::__construct( 'zozo_about_widget', esc_html__('Pixzlo About Me', 'pixzlo-core'), $widget_ops, $control_ops );
	...
	public function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php esc_html_e('Image URL:', 'pixzlo-core'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'round' ) ); ?>"><?php esc_html_e('Make image a circle:', 'pixzlo-core'); ?></label>
			...
			<br><small><?php esc_html_e('For a perfect circle your image need to have the same height and width. For example: 260x260', 'pixzlo-core'); ?></small>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>"><?php esc_html_e('About me text:', 'pixzlo-core'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'sign_image' ) ); ?>"><?php esc_html_e('Signature Image URL:', 'pixzlo-core'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'author_url' ) ); ?>"><?php esc_html_e('Author Url:', 'pixzlo-core'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'readmore_text' ) ); ?>"><?php esc_html_e('Read More Text:', 'pixzlo-core'); ?></label>
